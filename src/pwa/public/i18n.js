...
const _EN = {
  ...
  '代你提交订单售后【请求】:确认收货(托管释放给卖家)、直付未付款取消、申请退货 —— 每一项都只是提交,你在 PWA 看到精确后果并用 Passkey 批准后才会执行': 'Submit after-sales REQUESTS on your orders: confirm receipt (releases escrow to the seller), cancel an unpaid Direct Pay order, request a return — each is submit-only; nothing executes until you review the exact consequences in the PWA and approve with your Passkey',
