...
const _EN = {
  ...
  '新品发现': 'New Finds',
  '新近上架': 'Just listed',
  '启用自动下单需先设置默认地址 ': 'Auto-order requires default address ',
  '搜索中...': 'Searching...',
  ...
  '省市区街道，用于自动下单': 'Province/city/street — used for auto-order',
  '改': 'Edit',
  ...
  '输入或粘贴…': 'Type or paste…',
  '外链场景：找到更优方案自动下单（需已设置默认地址）': 'External link: auto-order the better match (requires default address)',
  '智能识别': 'Auto detect',
  '扫码识别': 'Scan code',
  '真实验证': 'Verified',
  '暂无新品': 'No new items',
  ...
  '更多筛选': 'More filters',
  '退货保障': 'Return policy',
  '外链场景自动下单': 'Auto-buy on external links',
  '仅对粘贴外链生效；找到 WebAZ 同款且推荐 → 自动扣款下单（不可逆）': 'External-link only: when WebAZ has matching SKU + recommendation → auto-deduct + place order (IRREVERSIBLE)',
