...
const _EN = {
  ...
  '现实性说明:佣金层级按地区合规配置生效;当前预发布期全局上限为 1 级(仅 L1)。"三级(7:2:1)"是协议最大设计,不构成对未来层级的承诺。': 'Reality note: commission levels follow per-region compliance config; during pre-launch a global cap of 1 level (L1 only) applies. "Three tiers (7:2:1)" is the protocol maximum design — not a promise of future levels.',
  ...
  '了解详情': 'Learn more',
  '协议费仅 2% · 分享成交拿 commission · 链上稳定币直达 · Agent 自动比价命中': 'Only 2% protocol fee · Share-to-earn commission · On-chain stablecoin payout · Agent price-match',
  '当前搜索': 'Current search',
  ...
  '· 分享成交拿分享佣金(层级按地区合规配置,当前预发布期仅 L1)': '· Earn share commission (levels follow per-region compliance config; pre-launch L1 only)',
  ...
  '③ 设你的 WebAZ 价 → 一键上架（仅需商品价格 15% 质押）': '③ Set your WebAZ price → one-click list (15% stake of product price)',
  ...
  '分享佣金按地区层级自动拆账(当前预发布期仅 L1)': 'Auto share-commission split per region-configured tiers (pre-launch: L1 only)',
  '链上稳定币结算，无平台资金截留': 'On-chain stablecoin settlement',
  '零保证金 / 零月费，仅需商品价格 15% 质押': 'No deposit / monthly fee, only 15% stake of product price',
  ...
  '链上稳定币直达，资金即时入卖家钱包': 'On-chain stablecoin direct settlement',
  ...
  '链上稳定币结算，资金即时入卖家钱包': 'On-chain stablecoin settlement',
  ...
  '精准命中买家搜索 · 链上稳定币即时入账 · Agent 自动推荐': 'Precise buyer match · Instant stablecoin · Agent auto-recommend',
  ...
  '稳定币结算，无平台资金截留，到账即可提现': 'Stablecoin settlement, no platform float, withdraw anytime',
  ...
  '· 链上稳定币直达，资金即时入卖家钱包': '· On-chain stablecoin direct — funds hit seller wallet instantly',
  ...
  '协议按地区层级自动拆分分享返佣(当前预发布期仅 L1)': 'The protocol auto-splits share commission per region-configured tiers (pre-launch: L1 only)',
  '笔记数':                            'Notes',
  '总点击':                            'Total clicks',
  '总赞数':                            'Total likes',
  '图':                                'photos',
  ...
  'DAO 治理':                          'DAO-governed',
  '直付已上线(非托管:不代持·不担保·不退款)· 托管轨=模拟测试币 · 邀请制预发布': 'Direct Pay is live (non-custodial: no holding · no guarantee · no refunds) · escrow rail = simulated test tokens · invite-only pre-launch',
  ...
  '这是 pre-launch 引导期的【临时治理模式】:更广的只读可见性 + 有限的应急写权限 —— 不是日常全能账号。': 'A TEMPORARY pre-launch governance mode: broader read visibility + limited emergency write powers — not an everyday all-powerful account.',
  '设计目标:launch 后把创始人权力拆成更窄的角色 —— maintainer / support operator / arbitrator / finance reviewer / security admin(用 regional admin + 权限位逐步收窄)。': 'By design, after launch founder powers are split into narrower roles — maintainer / support operator / arbitrator / finance reviewer / security admin (via regional admins + permission bits, narrowed step by step).',
