    ...
    <div class="card" style="background:linear-gradient(135deg,#eef2ff,#fff);padding:14px;margin-bottom:10px">
      ...
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:8px;text-align:center">
        <div>
          ...
          <div style="font-size:10px;color:#6b7280">GMV (USDC)</div>${window.gmvRailSplitHtml ? window.gmvRailSplitHtml(r.orders.gmv_escrow, r.orders.gmv_direct_pay, r.orders.gmv_usdc_escrow, fmt2, r.orders.gmv_other) : ''}
        </div>
        <div>
