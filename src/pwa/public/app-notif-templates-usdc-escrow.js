...
;(function () {
  ...
  Object.assign(window.NOTIF_TEMPLATES, {
    ...
    ord_confirmed_completed_ue: P('✅', '交易完成，链上已结算', '订单「{product}」交易完成，货款已由链上合约结算至你的收款地址(平台不经手)。'),
    usdc_dead_deposit_buyer: P('⚠️', '资金已入合约但订单已取消', '你的 USDC 已进入链上担保合约，但该订单已取消。资金仍在链上合约中；平台已收到告警并会人工跟进，请在订单页联系我们。'),   // B6b-2 B5:链上退款(B7)未接线 —— 旧文案承诺的自动退款/「请勿担心」背后没有任何机制
    usdc_dead_deposit_seller: P('⚠️', '已取消订单收到链上存入，请勿发货', '一笔已取消订单收到了买家的链上存入。请勿发货；资金仍在链上合约中，平台已收到告警并会人工跟进。'),   // B6b-2 B5:同上 —— 旧文案宣称的链上退款处理今天没有任何代码在执行
  })
})()
