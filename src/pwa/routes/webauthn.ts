...
export interface WebauthnDeps {
  ...
  requireHumanPresence: (                                     // #1044 — DELETE passkey 自身要 Passkey gate
    userId: string,
