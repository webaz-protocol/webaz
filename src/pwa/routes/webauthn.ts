...
export interface WebauthnDeps {
  ...
  requireHumanPresence: (                                     // #1044 — DELETE passkey 自身要 Passkey gate;RFC-020 pair approve 同机制
    userId: string,
    purpose: 'delete_passkey' | 'agent_pair_approve',
