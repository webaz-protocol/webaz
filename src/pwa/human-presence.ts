...
export type HumanPresencePurpose = 'vote' | 'arbitrate' | 'agent_revoke' | 'agent_pair_approve' | 'agent_permission_approve' | 'delete_passkey' | 'identity_claim' | 'oauth_consent_approve' | 'product_action_approve' | 'usdc_escrow_arbiter_resolve' | 'usdc_escrow_arbiter_flag'
