...
export const KNOWN_STALE_WIDGET_HASHES: Readonly<Record<string, readonly string[]>> = {
  'webaz-products':            ['c4bd5e13bb', '48c4e4cb06', '2992d4bf3f', 'f1688b621b', 'bc1a887d88', 'e87312858c', '8edeb847f3', '212893345f'],
  'webaz-products-mcp':        ['ea12ee851a', 'b4d9cb133c', '3b8c59d367', 'b9b8e577a8', '334fe638ce', '4d42fe0623', '9e1ebdac31', '97a9101d7c'],
