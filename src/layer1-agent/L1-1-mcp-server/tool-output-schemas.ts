...
export const OUTPUT_SCHEMAS: Record<string, Record<string, unknown>> = {
  ...
  webaz_quote_order: {
    ...
    properties: {
      ...
      payment_rail: { type: 'string' }, rail_note: { type: 'string', description: 'per-rail honesty note: escrow(WAZ)=simulated; usdc_escrow=real USDC in the Base contract; direct_p2p=no principal held' },
