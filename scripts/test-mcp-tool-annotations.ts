...
async function main(): Promise<void> {
  ...
  ok('3. current tool count == 55 (derived from live tools + map; +webaz_buyer_action_request + webaz_upload_product_image)', tools.length === mapKeys.length && tools.length === 56)
