...
| POST | `/api/products/:id/links` | 🔐 |  | 新链接（无人认领）直接 verified=1；已被他人认领则发起众包验证任务 | src/pwa/routes/products-links.ts:58 |
| DELETE | `/api/products/:id/links/:linkId` | 🔐 |  |  | src/pwa/routes/products-links.ts:190 |
